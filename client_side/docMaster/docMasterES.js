...
//			oTable.fnDraw();//reset
		...
		ajax: {
		      ...
		      data: function ( d ) {
				return JSON.stringify( {"params": sessionData, "DT": d})
//				return {params: JSON.stringify(sessionData)}
				//return JSON.stringify({"applications" : ["sca","www"]});
			  },
              url: config.apiURL+"/getDocPage2",
		      //data: sessionData,
		      //dataType: 'json',
...
function getFacets(callback2){
	...
	var ret_facets;
	var newURL = config.apiURL+"/docMasterFacets";
...
//      contentType: 'application/json;charset=UTF-8',
      ...
      url: config.apiURL+"/docMasterFacets",
      //data: sessionData,
...
//		      dataType: 'text',
              ...
              url: config.apiURL+"/getGeneralEstimates",
		      data: JSON.stringify(ajaxParams),
//		      data: sessionData,
		      success: function(data){
				  console.log("response from getTopicEstimates");
				  console.log(data);
...
//	      url: config.dataURL+"/filters/getDocTypeEstimates.sjs",
          url: config.apiURL+"/getGeneralEstimates",
//          url: config.apiURL+"/getDocTypeEstimates",
 	      data: JSON.stringify(ajaxParams),
	      success: function(data){
			  console.log("response from getDocTypeEstimates");
	    	  console.log(data);
    ...
    if(sessionData.institutions.length > 0){
		...
		$.ajax({
		      ...
		      data: JSON.stringify(ajaxParams),
		      success: function(data){
				  console.log("response from getInstEstimates");
				  console.log(data);
