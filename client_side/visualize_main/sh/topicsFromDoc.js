...
queue()
//.defer(d3.json, fname1)
//.defer(load_json_data, fname1)
//.defer(load_json_data, fname1)
//.defer(unzip_json_data, fname1)
//.defer(load_json_data_zipfile, fname1)
.defer(d3.csv, fnameTopics)
.defer(d3.csv, fnameSubTopics)
.defer(d3.csv, fnameCounts)
//.defer(d3.json, fname2)
.await(process);

//function process(error, datapoints,topicInfo,subTopicInfo,countInfo) {
function process(error, topicInfo,subTopicInfo,countInfo) {
...
if (typeof thisFilterSubTopic != 'undefined') {
   if ((thisFilterSubTopic >=0) && (thisFilterSubTopic <=2)) {
