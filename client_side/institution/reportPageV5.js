...
//   for(var i in sessionData.topics){
//	   chart.addSeries({
//		   name: String(i) + ": " + sessionData.topics[i].label,
//		   data: accelVals_t[thisTopN][i],
//		   grouping: false,
//		   pointPadding: 0,
//		   groupPadding: 0,
//		   dataLabels:{
...
//				   stops: [
//					   [0, 'rgba(255,255,255,0.5)'],
//					   [1,Highcharts.Color(Highcharts.getOptions().colors[i+1]).setOpacity(0.5).get('rgba')],
//				   ]
//			   }
//		   }
//	   })
