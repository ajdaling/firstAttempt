...
var numTopics = sessionData.numTopics;
...
for (var reportControl = 0; reportControl<numTopics+1; reportControl++) {
  ...
  var asyncResult = $.ajax({
	url: "http://"+config.host+":"+config.port+"/report/reportPageTopic.sjs",
...
//				allRates_t3.push({
				...
				console.log("color");
				console.log(Highcharts.getOptions().colors[nameInd])
				rateData[4].push({
//				allRates_t4.push({
         		 name:allBubble.name ,
         		 data: dataPacket,
