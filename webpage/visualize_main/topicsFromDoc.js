...
//for(var i = 1; i < 8; i++){
//	topic_str = "topic"+String(i);
//	if(reportData.hasOwnProperty(topic_str)){
//		topicDefs[i].topic = reportData[topic_str];
//	}
//}
...
for(var i = 0; i < 8; i++){
	var str = "topic"+String(i);
	if(reportData.hasOwnProperty(str)){
		topicDefs[str] = reportData[str];
		topicNames.push(str);
		topicTitles.push(String(str)+":"+reportData[str]);
	}
}
console.log(topicDefs);	

for(var t in topicDefs){
