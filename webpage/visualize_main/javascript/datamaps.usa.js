...
//REH added
    ...
    if ( self.options.zoomConfig.zoomOnClick ) {
      bubbles
//REH        .on('click', function (d) { clickZoom.call(self, d) });
        .on('click', null);
    }
...
//            .style('position', 'relative');
  ...
  ***************************************/
  ...
  Datamap.prototype.updateChoropleth = function(data) {
	...
	if (color === undefined) color = this.options.fills.defaultFill;
        //console.log(subunit);
        //console.log(color);
        svg
          .selectAll('.' + subunit)
...
//      var position = d3.mouse(self.svg[0][0].parentElement);
      d3.select(self.svg[0][0].parentNode).select('.datamaps-hoverover')
//        .style('top', (d3.event.pageY + 16) + "px")
        .style('top', ( (position[1] + 30)) + "px")
//        .style('top', ( (position[1] + 800)) + "px")
        .html(function() {
